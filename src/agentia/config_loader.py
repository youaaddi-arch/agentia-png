...
NOMS: Dict[str, str] = {
    ...
    "responsable_administratif": "Farid Finance",
    "responsable_certification_rs": "Aminata Qualité",
    "community_manager": "Lina Réseaux",
    "webmaster_seo": "Sofiane Référencement",
    "expert_google_ads": "Aya Pub",
    "veilleur_appels_offres": "Nadia Veille",
    "redacteur_memoire_technique": "Rayan Technique",
    "monteur_dossier_ao": "Dounia Dossier",
    "charge_prospection": "Léo Prospect",
    "redacteur_propositions": "Bilal Devis",
    "gestionnaire_emails": "Myriam Mail",
