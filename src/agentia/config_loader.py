...
NOMS: Dict[str, str] = {
    CEO: "Stella Stratégie",
    "responsable_marketing": "Marco Marketing",
    "responsable_marches_publics": "Marc Public",
    "responsable_commercial": "Vince Vente",
    "assistante_direction": "Aïda Agenda",
    "responsable_administratif": "Finn Finance",
    "responsable_certification_rs": "Quentin Qualité",
    "community_manager": "Lina Réseaux",
    "webmaster_seo": "Seb Référencement",
    "expert_google_ads": "Ada Pub",
    "veilleur_appels_offres": "Vic Veille",
    "redacteur_memoire_technique": "Théo Technique",
    "monteur_dossier_ao": "Dora Dossier",
    "charge_prospection": "Léo Prospect",
    "redacteur_propositions": "Davy Devis",
    "gestionnaire_emails": "Mélanie Mail",
    "gestionnaire_drive": "Clara Cloud",
    "redacteur_comptes_rendus": "Renée Rapport",
    "suivi_documents": "Valentine Validité",
    "facturation_tresorerie": "Fanny Facture",
    "preparateur_audits": "Audrey Audit",
    "redacteur_procedures": "Paul Procédure",
}
